...
variable "create_verification_record" {
  description = "If you set this variable to false, this module will not create a verification record within Route53."
  type        = bool
  default     = true
}

variable "verify_certificate" {
  description = "If you set this variable to false, this module will not verify the ACM certificate."
  type        = bool
  default     = true
}
