...
func getSnapshotId(dbIdentifier string, isAuroraDb bool, rdsClient *rds.RDS, snapshotSuffix string) (string, error) {
	if isAuroraDb {
		input := rds.DescribeDBClusterSnapshotsInput{DBClusterIdentifier: awsgo.String(dbIdentifier)}
		...
		input := rds.DescribeDBSnapshotsInput{DBInstanceIdentifier: awsgo.String(dbIdentifier)}
