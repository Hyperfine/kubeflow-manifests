...
:type: service
:name: MySQL
:description: Deploy and manage MySQL on AWS using Amazon's Relational Database Service (RDS)
:icon: ../../_docs/mysql.png
:category: database
:cloud: aws
:tags: data, database, sql, rds, mysql
:license: gruntwork
...
This module deploys MySQL on top of Amazon Relational Database Service (RDS). The cluster is managed by AWS
