...
:type: service
:name: Oracle
:description: Deploy and manage Oracle on AWS using Amazon's Relational Database Service (RDS)
:icon: ../..//_docs/oracle.png
:category: database
:cloud: aws
:tags: data, database, sql, rds, oracle
:license: gruntwork
...
This module deploys Oracle on top of Amazon Relational Database Service (RDS). The cluster is managed by AWS
