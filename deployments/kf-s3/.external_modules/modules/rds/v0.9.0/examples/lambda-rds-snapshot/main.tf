...
module "mysql" {
  ...
  # source = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/data-storage/rds?ref=v1.0.8"
  source = "../../modules/rds"
...
module "mysql_share_snapshot" {
  # When using these modules in your own templates, you will need to use a Git URL with a ref attribute that pins you
  # to a specific version of the modules, such as the following example:
  # source = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/lambda-share-snapshot?ref=v1.0.8"
...
module "mysql_cleanup_snapshots" {
  # When using these modules in your own templates, you will need to use a Git URL with a ref attribute that pins you
  # to a specific version of the modules, such as the following example:
  # source = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/lambda-cleanup-snapshots?ref=v1.0.8"
