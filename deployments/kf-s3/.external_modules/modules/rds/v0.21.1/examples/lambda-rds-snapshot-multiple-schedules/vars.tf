...
variable "max_hourly_snapshots" {
  description = "The maximum number of hourly snapshots to keep around of the given DB. Once this number is exceeded, this lambda function will delete the oldest snapshots."
  type        = number
  default     = 72
}

variable "max_weekly_snapshots" {
  description = "The maximum number of weekly snapshots to keep around of the given DB. Once this number is exceeded, this lambda function will delete the oldest snapshots."
  type        = number
  default     = 26
}
