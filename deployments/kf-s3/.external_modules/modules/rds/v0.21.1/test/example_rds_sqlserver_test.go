...
func TestRdsSqlServer(t *testing.T) {
	t.Parallel()
	...
	terraformDir := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/rds-sqlserver")
	...
	assert.Equal(t, "1433", terraform.Output(t, terraformOptions, "sqlserver_port"))
	assert.Equal(t, "default.sqlserver-ex-15.0", terraform.Output(t, terraformOptions, "sqlserver_parameter_group_name"))
}
