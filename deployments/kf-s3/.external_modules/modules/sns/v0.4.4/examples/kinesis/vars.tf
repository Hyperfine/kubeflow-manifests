...
# section for the number of shards to be caculated based on AWS guidance BUT NOT BOTH!
# Sizing guide located at: https://docs.aws.amazon.com/streams/latest/dev/amazon-kinesis-streams.html
# ---------------------------------------------------------------------------------------------------------------------
