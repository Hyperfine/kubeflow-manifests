...
variable "redis_monitor_database_memory_usage_percentage" {
  description = "Should database memory usage percentage be monitored?"
  type        = bool
  default     = false
}

variable "redis_monitor_curr_connections" {
  description = "Should current connections be monitored?"
  type        = bool
  default     = false
}

variable "redis_monitor_replication_lag" {
  description = "Should replication lag be monitored?"
  type        = bool
  default     = false
}
