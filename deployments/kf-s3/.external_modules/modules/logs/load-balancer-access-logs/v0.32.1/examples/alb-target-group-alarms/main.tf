...
# production, you will want to use the Gruntwork Module terraform-aws-ecs/ecs-service-with-alb to generate a Target Group, versus
...
module "alb_tg_alarms" {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-monitoring.git//modules/alarms/alb-target-group-alarms?ref=v1.0.8"
