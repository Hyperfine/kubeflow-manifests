...
variable "memory_metric_namespace" {
  description = "The CloudWatch Namespace where the memory metrics are reported. Defaults to what is used by the CloudWatch Agent (agents/cloudwatch-agent module)."
  type        = string
  default     = "CWAgent"
}

variable "memory_metric_name" {
  description = "The name of the CloudWatch metric that tracks Memory utilization. Defaults to what is used by the CloudWatch Agent (agents/cloudwatch-agent module)."
  type        = string
