...
func TestEc2Alarms(t *testing.T) {
	t.Parallel()
	...
	test_structure.RunTestStage(t, "setup", func() {
		...
		terraformOptions := &terraform.Options{
			...
			TerraformDir: fmt.Sprintf("%s/ec2-alarms", examplesDir),
	...
	// TODO: figure out a way to 1) make CPU, memory, and disk space usage high on the EC2 Instances,
