...
* [elasticache-memcached-alarms](/modules/alarms/elasticache-memcached-alarms) and [elasticache-redis-alarms](/modules/alarms/elasticache-redis-alarms): Alarms for an ElastiCache cluster that go off if the CPU
