...
variable "cache_node_ids" {
  description = "The list of ids of the ElastiCache nodes"
  type        = list(string)
}

variable "num_cache_node_ids" {
  description = "The number of ids in var.cache_node_ids. We should be able to compute this automatically, but can't due to a Terraform bug: https://github.com/hashicorp/terraform/issues/3888"
  type        = number
}
