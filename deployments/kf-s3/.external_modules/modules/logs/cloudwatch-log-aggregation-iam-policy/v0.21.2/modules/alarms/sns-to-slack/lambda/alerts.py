...
class CloudWatchNotification(BaseNotification):
  ...
  def __init__(self, *args, **kwargs):
    super(CloudWatchNotification, self).__init__(*args, **kwargs)
...
class SimpleNotification(BaseNotification):
  ...
  def __init__(self, *args, **kwargs):
    super(SimpleNotification, self).__init__(*args, **kwargs)
...
def post_to_slack(body):
  if not SLACK_WEBHOOK_URL:
    raise Exception("Please define the environment variable SLACK_WEBHOOK_URL")

  req = Request(SLACK_WEBHOOK_URL, json.dumps(body))
