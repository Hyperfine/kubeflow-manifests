...
This module adds alarms for metrics produced by an [Amazon Simple Queue Service (SQS)](https://aws.amazon.com/sqs/).
They will go off if the the number of visible messages is too high or age of oldest message surpasses the threshold.

## How do you use this module?

Check out the [examples/sqs-alarms example](/examples/sqs-alarms).
