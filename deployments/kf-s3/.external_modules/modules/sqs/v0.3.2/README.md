...
This repo contains modules for deploying and managing [AWS Simple Queue Service](https://aws.amazon.com/sqs/) queues,
 [AWS Simple Notification Service](https://aws.amazon.com/sns/) topics and 
 [AWS Kinesis](https://aws.amazon.com/kinesis/) streams.

* [sqs](/modules/sqs): A module for deploying and managing SQS queues.
* [sns](/modules/sns): A module for deploying and managing SNS topics.
* [kinesis](/modules/kinesis): A module for deploying and managing Kinesis streams.
...
module "ecs_cluster" {
  ...
  // set the parameters for the sns module
}
```
